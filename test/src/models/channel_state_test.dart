  ...
  group('src/models/channel_state', () {
   ...
   "members": []
    ...
    test('should parse json correctly', () {
      ...
      expect(channelState.channel.extraData['image'], "https://cdn.chrisshort.net/testing-certificate-chains-in-go/GOPHER_MIC_DROP.png");
      ...
      expect(channelState.messages[0].createdAt, DateTime.parse("2020-01-29T03:23:02.843948Z"));
