...
class Channel {
  ...
  Future<QueryRepliesResponse> getReplies(String parentID, PaginationParams options) async {
    final response =
        await _client.dioClient.get<String>("/messages/$parentID/replies", queryParameters: options.toJson());
